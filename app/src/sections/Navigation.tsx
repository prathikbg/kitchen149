      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10 h-[68px] flex items-center justify-between">
          <a href="#" className="flex items-center gap-2">
            <span className="text-[18px] font-bold tracking-[0.08em] text-white">KITCHEN <span className="text-[#E11D48]">149</span></span>
          </a>

          <div className="hidden md:flex items-center gap-9">
            {navLinks.map((l) => (
              <a key={l.label} href={l.href}
                className={`text-[11px] tracking-[0.22em] font-semibold transition-colors ${
